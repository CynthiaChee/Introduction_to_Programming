...
int main()
{
    ...
    while ( not quit_requested() )
    {
        ...
        /*if (key_typed(L_KEY))                 // This was from my previous submission (Custom Program). The functionality has
        {                                       // been removed for this version but I left the code here to show the changes
            game.player.level +=1;              // applied to this program
