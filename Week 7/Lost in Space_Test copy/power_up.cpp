...
//point_2d_mini_map_coordinate(const power_up_data &power_up)
//{
    //double x, y;
    //power_up_data power_up;
    //x = (sprite_x((power_up.power_up_sprite) - MIN_XY)/((3000*100) + x));
    //y = (sprite_x((power_up.power_up_sprite) - MIN_XY)/((3000*100) + y));
    //point_2d point_at(x);
    //point_2d point_at(y);
//}